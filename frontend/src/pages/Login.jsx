...
export default function Login() {
  ...
  // Handle external login token on redirect
  useEffect(() => {
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6">
             <div className="grid grid-cols-2 gap-3">
                <button onClick={() => handleExternalLogin('Google')} className="flex items-center gap-2 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-3 py-1.5 rounded-md text-sm font-medium transition-colors shadow-sm">
          ...
          <button onClick={() => handleExternalLogin('Microsoft')} className="flex items-center gap-2 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-3 py-1.5 rounded-md text-sm font-medium transition-colors shadow-sm">
